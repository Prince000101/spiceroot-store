...
const Register = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4 sm:px-6 transition-colors duration-500">
      <SEO
        title="Register"
        description="Create your SpiceRoot account to start saving your favorite masalas and tracking orders."
        url="/register"
      />
      <div className="w-full max-w-md rounded-[20px] sm:rounded-[28px] bg-white dark:bg-charcoal-light p-5 sm:p-6 md:p-8 shadow-sm border border-sand/20 dark:border-forest-light/30">
        <div className="mb-6 sm:mb-8 text-center">
          ...
          <h2 className="mt-3 sm:mt-4 text-2xl sm:text-3xl font-playfair text-forest dark:text-cream">Join SpiceRoot</h2>
          <p className="mt-1 sm:mt-2 text-sm sm:text-base text-forest dark:text-cream/60 font-dm">Sign up to start saving your wellness items</p>
        </div>
