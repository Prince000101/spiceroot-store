    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-3 sm:gap-4">
      {stats.map((stat, idx) => {
        ...
        return (
          <div
            key={idx}
            className="bg-white dark:bg-charcoal-light shadow-sm border border-gray-100 dark:border-forest-light/20 rounded-xl sm:rounded-2xl p-4 sm:p-5 text-center hover:shadow-md transition-shadow"
          >
